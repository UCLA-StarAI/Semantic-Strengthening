...
import mnist_perfect_matching.data_utils as mnist_perfect_matching_data
import mnist_perfect_matching.trainers as mnist_perfect_matching_trainers


dataset_loaders = {
    "mnist_perfect_matching": mnist_perfect_matching_data.load_dataset
}

trainer_loaders = {
    "mnist_perfect_matching": mnist_perfect_matching_trainers.get_trainer
}
